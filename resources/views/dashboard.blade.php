    ...
    <div class="py-12">
        <div class="max-w-full mx-auto px-6">
            ...
            <form method="GET" action="{{ route('getpremium') }}" class="max-w-2xl mx-auto px-6 mt-4">
                @csrf
                <button class="border-2 border-green-500 hover:border-green-300 w-full text-green-500 hover:text-green-300 text-xl  px-4 py-2 rounded-xl transition-all duration-300">GET THE GAY VERSION</button>
            </form>
            @endif
